...
Consider binary representation of 6. It's 110 (with an
...
#eval mth_bit_from_right_in_binary_representation_of_n 1 7
...
if (m >= 2^n)
    then λ v, ff --returns function with variable v, and false
else
    λ v : var, 
    match v with
    | (var.mk i) := 
...
-- converting list of var-> bool to a list of bool
...
/-
let n... P ∧ (Q ∨ ¬ P) ==> {P, Q}
let rs... list of all bools
def defines in global environment
let...in... defines locally/ in the scope
-/
